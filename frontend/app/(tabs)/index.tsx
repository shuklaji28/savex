...
const s = StyleSheet.create({
  ...
  warningBox: { backgroundColor: '#1C1A0F', borderLeftWidth: 3, borderLeftColor: '#F59E0B', borderRadius: 8, padding: 10, marginBottom: 8 },
  warningTitle: { color: '#F59E0B', fontWeight: '600', fontSize: 13, marginBottom: 4 },
  warningText: { color: '#D4AC0D', fontSize: 12, lineHeight: 18 },
  warningSubtext: { color: '#78716C', fontSize: 11, marginTop: 4, fontStyle: 'italic' },
